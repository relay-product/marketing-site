...
export const OfferIcon = ({ capability, ...props }: OfferIconProps) => (
  <Icon width="764" height="207" viewBox="0 0 764 207" fill="none" {...props}>
    <circle
      cx="660.5"
      cy="103.5"
      r="102"
      stroke={capability === "Full Stack Engineering" ? "#E1992C" : "white"}
      stroke-width="3"
    />
    <circle
      cx="660.5"
      cy="103.5"
      r="63"
      stroke={capability === "Strategy" ? "#E1992C" : "white"}
      stroke-width="3"
    />
    <circle
      cx="660.5"
      cy="103.5"
      r="83"
      stroke={capability === "UI/UX Design" ? "#E1992C" : "white"}
      stroke-width="3"
    />
    <path
      ...
      fill={capability === "Strategy" ? "#E1992C" : "white"}
    />
    <path
    ...
    />
    <path
      d="M565.667 152C565.667 154.946 568.054 157.333 571 157.333C573.946 157.333 576.333 154.946 576.333 152C576.333 149.055 573.946 146.667 571 146.667C568.054 146.667 565.667 149.055 565.667 152ZM203 153L571 153L571 151L203 151L203 153Z"
      fill={capability === "Full Stack Engineering" ? "#E1992C" : "white"}
    />
  </Icon>
);
